...
import {
  LayoutDashboard, Flower2, ShoppingBag, Settings,
  Menu, X, ChevronRight, Bell, LogOut, Leaf,
} from "lucide-react";
import { useAdminAuth } from "../../admin/context/AdminAuthContext";
import { TENANT_ADMIN_NAV } from "../../admin/data/adminNav";

const ICON_MAP = { LayoutDashboard, Flower2, ShoppingBag, Settings };
...
function Sidebar({ collapsed, setCollapsed, mobileOpen, setMobileOpen }) {
  ...
  const sidebarContent = (
    <div className="h-full flex flex-col bg-slate-900">
      ...
      {/* Nav */}
      <SidebarNav collapsed={collapsed} onClose={() => setMobileOpen(false)} />
...
function TenantHeader({ setMobileOpen }) {
  const { user } = useAdminAuth();
  return (
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <TenantHeader setMobileOpen={setMobileOpen} />
